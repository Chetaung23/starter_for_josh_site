...
<header class="container-fluid" style="background-size: cover; background-image: url(<?php the_field('headerbackgroundimage') ?>);">
    ...
    <nav class="navbar navbar-expand-md navbar-dark">
        ...
        <lottie-player src="http://170.187.231.66/~meshatmurdoch3/wp-content/themes/starter_for_josh_site/images/logo-anim.json" background="transparent" speed="1" style="width: 250px; height: 100px" direction="1" mode="normal" autoplay></lottie-player> </a>
